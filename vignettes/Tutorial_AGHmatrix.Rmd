---
title: "AGHmatrix: An R package to compute relationship matrices for diploid and autopolyploid
  species"
...
Currently the package computes the following 14 different relationship matrices:
...
Additionally there is a beta implementation to compute A matrix when parentage is not deterministic as in polycross design. 
...
#Computing dominant relationship matrix for diploids:
...
#Computing additive relationship matrix for autooctaploids:
